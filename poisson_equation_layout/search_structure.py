...
if __name__ == "__main__":
    ...
    exp = RetiariiExperiment(model_space, evaluator, [], strategy.PolicyBasedRL(max_collect=50,trial_per_collect =1))
    exp_config = RetiariiExeConfig('local')
    exp_config.experiment_name = 'heat equation layout'
    ...
    import json
    json.dump(exported_arch_best, open('layout_struct.json', 'w'))
