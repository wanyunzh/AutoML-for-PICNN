...
import random
from possion_enastrain import My_EnasTrainer,My_DartsTrainer
...
def search():
    ...
    # trainer=My_EnasTrainer(model,num_epochs=15000)
    ...
    import json
    json.dump(exported_arch, open('darts15000.json', 'w'))


    with fixed_arch('darts15000.json'):
